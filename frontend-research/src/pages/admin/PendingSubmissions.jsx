...
const PendingSubmissions = () => {
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const data = await api.get('/admin/papers?status=UNDER_ADMIN_APPROVAL');
      if (data) {
        setPapers(data);
      }
    } catch (err) {
      ...
      <div className={styles.mainContent}>
        ...
        <main className={styles.pageBody}>
          <div className={styles.breadcrumb}>
            ...
            <ChevronRight size={14} />
            <span className={styles.breadcrumbActive}>Pending Submissions</span>
          </div>
          ...
          <div className={styles.pageHeader}>
            <div>
              ...
              <p className={styles.pageSubtext}>
                Papers currently under admin approval, awaiting originality check or assignment.
              </p>
            </div>
          </div>
