...
/**
 * NotificationsPage – Full list view of all user notifications.
 * Accessible from:
 *  - Notification bell dropdown "View all"
 *  - Sidebar "Notifications" link
 *  - Profile dropdown "Notifications" link
 */
            ...
            <div className={styles.pageHeader}>
              <div>
                ...
                <p className={styles.pageSubtitle}>
                  Everything happening across your submissions, reviews, and the repository.
                </p>
              </div>
              <button
